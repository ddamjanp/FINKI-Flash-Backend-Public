...
public class PDFExportServiceImpl implements PDFExportService {
    ...
    private final QuizQuestionService quizQuestionServiceImpl;

    public ByteArrayInputStream exportQuiz(Long quizId) {
        List<QuizQuestion> questions = quizQuestionServiceImpl.findByQuizId(quizId);
        return generateQuizPdf(questions);
    }

    public ByteArrayInputStream generateQuizPdf(List<QuizQuestion> questions) {
